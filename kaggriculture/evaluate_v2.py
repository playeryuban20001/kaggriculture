...
def evaluate_agents(agent1, agent2, num_episodes=10):
    ...
    for i in range(num_episodes):
        ...
        print(f"Episode {i+1:02d}/{num_episodes} | V2 (Agent 1): {r1:7.1f} | V1 (Agent 2): {r2:7.1f}")
...
if __name__ == "__main__":
    results = evaluate_agents(kaggriculture_v2_agent.agent, kaggriculture_v1_agent.agent, num_episodes=NUM_EPISODES)
