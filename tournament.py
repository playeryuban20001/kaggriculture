...
GLOBAL_PATHS = {
    ...
    'V10 AI Farmer': r'g:/po/kaggriculture/kaggriculture_v10_ai_farmer.py',
    'V9 Evolved': r'g:/po/kaggriculture/kaggriculture_v9_evolved.py',
}
...
if __name__ == '__main__':
    ...
    print(f'Starting 4-Model Tournament ({len(tasks)} matches total)...')
    t0 = time.time()
